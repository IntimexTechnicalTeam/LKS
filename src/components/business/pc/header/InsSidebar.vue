<template>
  <div class="siderbarContainer">
    <div id="sidebar" v-show="isShow">
      ...
      <span v-show="show">
        <a
          href="https://api.whatsapp.com/send?phone=85268993722&text=%E6%88%91%E6%83%B3%E6%9F%A5%E8%AF%A2%E4%B8%80%E4%B8%8B"
          target="_blank"
        ...
        /></a>
        <a href="tel:85268993722" class="fb-button" target="_blank"
    ...
    <div class="fb-livechat">
      ...
      <div class="fb-widget">
        ...
        <div
          class="fb-page"
          data-href="https://www.facebook.com/LKSDisplaybox/"
          data-tabs="messages"
        ...
        >
          <blockquote
            cite="https://www.facebook.com/LKSDisplaybox/"
            class="fb-xfbml-parse-ignore"
          ></blockquote>
        </div>
        <div class="fb-credit">
          <a href="https://www.facebook.com/LKSDisplaybox/" target="_blank"
            >Facebook Chat Widget by LKS</a
          >
        </div>
        <div id="fb-root"></div>
      </div>
      <a
        href="https://www.facebook.com/LKSDisplaybox/"
